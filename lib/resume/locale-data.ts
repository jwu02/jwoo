  ...
  workExperiences: [
    {
      ...
      bullets: [
        ...
        "Engineered a full-stack assessment platform that digitised a paper-based examination workflow using Next.js, NestJS, and LLMs, automating question-bank parsing, assessment generation, and free-text answer grading, with DingTalk integration for employee information and Langfuse for LLM observability and evaluation",
      ],
    },
  ],
  personalProjects: [
  ...
  workExperiences: [
    {
      ...
      bullets: [
        ...
        "构建全栈评测平台，将传统纸质考试流程数字化，基于 Next.js、NestJS 和大语言模型，自动完成题库解析、试卷生成及主观题评分，集成钉钉获取员工信息，并通过 Langfuse 实现 LLM 可观测性与评估",
      ],
    },
  ],
  personalProjects: [
